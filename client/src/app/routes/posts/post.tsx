...
import { usePost } from "@/features/posts/api/get-post-id";
import { useLikePost } from "@/features/posts/api/toogle-like";
import { createComment, getAllComments } from "@/helper";
            ...
            <Layout>
                <div className="container mx-auto px-4 md:px-6 py-8">
                    <div className="text-center">
                        ...
                        {/* <p className="text-destructive">{(post as AxiosError).message}</p> */}
                    </div>
                </div>
            </Layout>
        );
        ...
        <Layout>
            <div className="px-4 md:px-6 py-8">
                ...
                <article className="mx-auto">
                    ...
                    <div dangerouslySetInnerHTML={{ __html: post?.post.content ?? "" }} className="text-foreground" />
                </article>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <button
                            ...
                            className={`flex items-center gap-2 ${
                                post?.likeStatus === "liked" ? "text-destructive" : "text-muted-foreground"
                            } transition-colors duration-200 hover:opacity-80`}
                        >
                            <Heart className={`h-5 w-5 ${post?.likeStatus === "liked" ? "fill-current" : ""}`} />
